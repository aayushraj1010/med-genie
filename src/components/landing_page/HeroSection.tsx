...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen w-full bg-[#090909] px-[6%] pt-[175px] flex flex-col justify-center items-center gap-[60px] max-[768px]:pt-[120px] max-[640px]:gap-[40px]">
      ...
      >
        <p
          className="text-[#939393] text-[18px] font-normal leading-[150%]
