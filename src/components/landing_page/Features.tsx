...
export default function FeatureSection() {
  ...
  return (
    <section className="min-h-screen w-full bg-gradient-to-br px-[6%] py-[100px] flex flex-col justify-center items-center gap-[100px] max-md:gap-[60px] max-md:py-[60px]">
      ...
      <div data-aos="fade-up" className="w-full flex flex-col gap-[80px]">
        {features.map((f, index) => (
          <div
            key={f.id}
            className={`relative flex items-center justify-between w-full gap-[60px] max-lg:flex-col transition-all duration-700 ease-out transform ${
          ...
          >
            ...
            <div
              data-aos="fade-up"
              className="flex flex-col items-center gap-4 min-w-[60px]"
            >
              <div
                data-aos="fade-up"
